...
class AssessmentDiagnosis extends StatelessWidget {
  const AssessmentDiagnosis({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return AssessmentDiagnosisHome();
  }
}

class AssessmentDiagnosisHome extends StatefulWidget {
  const AssessmentDiagnosisHome({Key? key}) : super(key: key);

  @override
  State<AssessmentDiagnosisHome> createState() => _AssessmentDiagnosisHomeState();
}

class _AssessmentDiagnosisHomeState extends State<AssessmentDiagnosisHome> {
...
*/
  ...
  String? QuestionDrinking;
  final  QuestionDrinkingHowOften= TextEditingController();
                          ...
                          child: Form(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text("How much do you drink? (bottles)",
                                    style: GoogleFonts.montserrat(
                                      fontSize: 12,
                                      fontWeight: FontWeight.w600,
                                      color: Colors.black,
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: TextFormField(
                                        ...
                                        controller: QuestionDrinkingHowOften,
